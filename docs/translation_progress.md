...
- The name/faction/place audit covers 80 world-city, town, port, and settlement slots, recurring commodity slots, twelve additional faction slots, 188 shared character-name slots, and 119 ship-model slots. Shared offsets propagate these names across city, palace, market, tavern, route-map, and shipyard screens.
