...
WORLD_CITY_ENTRIES = (
    ...
    Arm9ProfileEntry("DK4_CITY_STOCKHOLM_B", 0x15DFB4, "ストックホルム", "Stockholm", "World city name", slot_size=16),
...
TOWN_UI_ENTRIES = (
    ...
    # Additional entries from the shared trade-good catalogue. These names
    # are reused by city reports, market screens, and route-map callouts.
    Arm9ProfileEntry("DK4_GOOD_LACQUERWARE", 0x15B960, "漆器", "Lacquer", "Global commodity name", slot_size=8),
    Arm9ProfileEntry("DK4_GOOD_CRYSTAL", 0x15B9A8, "水晶", "Crystal", "Global commodity name", slot_size=8),
    ...
    Arm9ProfileEntry("DK4_GOOD_WINE", 0x15BC88, "ワイン", "Wine", "Global commodity name", slot_size=8),
    Arm9ProfileEntry("DK4_GOOD_RUM", 0x15BC98, "ラム酒", "Rum", "Global commodity name", slot_size=8),
    ...
    Arm9ProfileEntry("DK4_GOOD_INDIGO", 0x15CAA0, "インディゴ", "Indigo", "Global commodity name", slot_size=10),
    Arm9ProfileEntry("DK4_GOOD_COCHINEAL", 0x15CB0C, "コチニール", "Cochineal", "Global commodity name", slot_size=10),
    Arm9ProfileEntry("DK4_GOOD_CHILI", 0x15CC74, "トウガラシ", "Chili", "Global commodity name", slot_size=10),
    Arm9ProfileEntry("DK4_GOOD_TAMARIND", 0x15CCC8, "タマリンド", "Tamarind", "Global commodity name", slot_size=10),
